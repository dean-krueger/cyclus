...
cdef cppclass CyclusAgentShim "CyclusAgentShim" (cpp_cyclus.Agent):  # C++CONSTRUCTORS CyclusAgentShim(cyclus::Context*)
    ...
    void AdjustMatlParams(cpp_cyclus.RequestBidMap[cpp_cyclus.Material].type&) except *
    void AdjustProductParams(cpp_cyclus.RequestBidMap[cpp_cyclus.Product].type&) except *
    # Extra interface
